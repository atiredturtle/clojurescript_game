...
return (new CustomEvent(event_name,(function (){var obj34095 = {"detail":data};
return obj34095;
})()));
} else {
...
var f = (function (){var pred__34102 = cljs.core._EQ_;
var expr__34103 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34102.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34103))){
return ((function (pred__34102,expr__34103){
return (function (p1__34096_SHARP_){
return console.warn(p1__34096_SHARP_);
});
;})(pred__34102,expr__34103))
} else {
if(cljs.core.truth_(pred__34102.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34103))){
return ((function (pred__34102,expr__34103){
return (function (p1__34097_SHARP_){
return console.debug(p1__34097_SHARP_);
});
;})(pred__34102,expr__34103))
} else {
if(cljs.core.truth_(pred__34102.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34103))){
return ((function (pred__34102,expr__34103){
return (function (p1__34098_SHARP_){
return console.error(p1__34098_SHARP_);
});
;})(pred__34102,expr__34103))
} else {
return ((function (pred__34102,expr__34103){
return (function (p1__34099_SHARP_){
return console.log(p1__34099_SHARP_);
});
;})(pred__34102,expr__34103))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34106){
...
var eval_fn = cljs.core.get.call(null,map__34107__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34109_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34111,(0),null);
var v = cljs.core.nth.call(null,vec__34111,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1515826685097
